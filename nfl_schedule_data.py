# NFL 2026 Season Schedule Data

NFL_SCHEDULE = {
    # AFC East
    "New England Patriots": {
        "home": ["Buffalo", "Miami", "N.Y. Jets", "Denver", "Green Bay", "Las Vegas", "Minnesota", "Pittsburgh"],
        "away": ["Buffalo", "Miami", "N.Y. Jets", "Chicago", "Detroit", "Jacksonville", "Kansas City", "Los Angeles", "Seattle"]
    },
    "Buffalo Bills": {
...
def normalize_team_name(name):
    """Normalize team names to match the main schedule keys"""
